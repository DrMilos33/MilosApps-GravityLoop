...
const deStatic = {
  ...
  settingsGame: "Spiel",
  settingsGameHelp: "Wähle Tempo und worum du fliegst.",
  ...
  celestialBody: "Sonne oder Mond",
  celestialBodyHelp: "Wähle, worum du fliegst.",
  sun: "Sonne",
  ...
  roundResetCopy:
    "Schwierigkeit und dein gewählter Orbit werden erst beim Übernehmen aktiv und starten die Runde neu.",
  ...
  legal: "Impressum",
  privacy: "Datenschutz",
  privacyInfo: "Datenschutz & lokale Speicherung",
...
const enStatic = {
  ...
  settingsGame: "Game",
  settingsGameHelp: "Choose the pace and what you orbit.",
  ...
  celestialBody: "Sun or Moon",
  celestialBodyHelp: "Choose what you orbit.",
  sun: "Sun",
  ...
  roundResetCopy:
    "Difficulty and your chosen orbit take effect only when applied and restart the run.",
  ...
  legal: "Legal notice",
  privacy: "Privacy",
  privacyInfo: "Privacy & local storage",
